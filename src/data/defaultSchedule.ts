...
export const defaultSchedule: DefaultScheduleConfig = {
  ...
  days: {
    day1: [
      ...
      { sourceKey: 'main-day-1', completed: false }
    ],
    day2: [
      { sourceKey: 'main-day-2', completed: false }
    ],
    day3: [
      { sourceKey: 'main-day-3', completed: false }
    ],
    day4: [
      { sourceKey: 'main-day-4-daytime', completed: false },
      { sourceKey: 'fixed-d4-dragon-bridge', completed: false }
    ],
    day5: [
      { sourceKey: 'main-day-5', completed: false }
    ],
    day6: [
      { sourceKey: 'main-day-6-museum', completed: false },
      { sourceKey: 'fixed-d6-flight', completed: false }
    ]
  }
};
